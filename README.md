...
```
dependencies {
    implementation 'de.idnow.android.sdk:idnow-platform:5.22.0' // replace "5.22.0" with the version you want to include
}
```
...
```
dependencies {
    implementation 'de.idnow.android.sdk:idnow-platform-no-fintec-XS2A:5.22.0' // replace "5.22.0" with the version you want to include
}
```
