...
```
dependencies {
    implementation 'de.idnow.android.sdk:idnow-platform:5.13.1' // replace "5.13.1" with the version you want to include
}
```
...
```
dependencies {
    implementation 'de.idnow.android.sdk:idnow-platform-no-fintec-XS2A:5.13.1' // replace "5.13.1" with the version you want to include
}
```
